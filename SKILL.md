...
1. **Прочитай `references/patterns.md` целиком.** Там все 32 паттерна: маркеры, лечение, примеры «до/после». Правка по памяти пропускает половину проблем.

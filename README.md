...
- **[19.07.2026] v1.4** 🔍 Линтер `scripts/lint.py`: жёсткие запреты ловит скрипт, а не совесть модели. Паттерны 33-34 - повтор глаголов и стопка абзацев, по ним живые читатели чаще всего опознают AI
